...
public class PremiumEnclosure extends AnimalEnclosure {
	String enclosureName;
	String enclosureManager;
	String enclosureOpeningTime;
	String enclosureClosingTime;
	final double DEFAULTPRICE = 10.00; // default minimum price
	final double MARKUP = 1.1; // mark up factor for price increases
	
	public PremiumEnclosure(String _name, double _weight, double _price, String _enclosureName, String _manager, String _openingTime, String _closingTime) {
	...
	public double getVeiwingPrice() {
		return this.veiwingPrice * MARKUP;  // the price charged should be increased by MARKUP factor (110%) on the saved price
	}
